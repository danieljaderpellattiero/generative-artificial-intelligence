...
def discriminator_loss(logits_real, logits_fake):
  ...
  ##############################################################################
  # Replace "pass" statement with your code
  t_labels = torch.ones_like(logits_real)
  f_labels = torch.zeros_like(logits_fake)
  loss_r = F.binary_cross_entropy_with_logits(logits_real, t_labels)
  loss_f = F.binary_cross_entropy_with_logits(logits_fake, f_labels)
  loss = loss_r + loss_f
  ##############################################################################
  #                              END OF YOUR CODE                              #
  ##############################################################################
...
def generator_loss(logits_fake):
  ...
  ##############################################################################
  # Replace "pass" statement with your code
  t_labels = torch.ones_like(logits_fake)
  loss = F.binary_cross_entropy_with_logits(logits_fake, t_labels)
  ##############################################################################
  #                              END OF YOUR CODE                              #
  ##############################################################################
  return loss
...
def ls_discriminator_loss(scores_real, scores_fake):
  ...
  ##############################################################################
  # Replace "pass" statement with your code
  loss_r = 0.5 * torch.mean((scores_real - 1) ** 2)
  loss_f = 0.5 * torch.mean(scores_fake ** 2)
  loss = loss_r + loss_f
  ##############################################################################
  #                              END OF YOUR CODE                              #
  ##############################################################################
